...
import { Link, useBreakpointValue, Card, CardBody, Stack, Slide, Flex, Image, Box, Button, Text, Heading, Tag, TagLabel, List, ListItem, UnorderedList, HStack, VStack} from '@chakra-ui/react';
