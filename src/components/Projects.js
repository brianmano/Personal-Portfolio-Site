...
import { Flex, VStack, Grid, GridItem, Heading, Text, useBreakpointValue, Divider  } from '@chakra-ui/react';
    ...
    return (
      <Flex justify="flex-start" width="100%" padding={{ base: '10', sm: '10' }} paddingBottom={0}>
        <VStack align="flex-start" spacing="5" width="100%">
          ...
          <Text fontFamily="Titillium Web, sans-serif;" color={fontcolour2} paddingX={0}>
